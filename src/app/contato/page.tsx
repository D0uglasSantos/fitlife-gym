      ...
      <div className="bg-bgContato bg-no-repeat bg-cover flex flex-col items-center gap-10 py-80 bg-center ">
        <div className="flex  items-center">
          <div className="flex-1 pr-8">
            ...
            <p className="text-center text-1xl text-color-details mb-3">
              ABDALLA MALL, EQS 502/503 <br />
              Asa Sul, Brasília - DF
            </p>
            <div className="lg:space-y-4 text-center mr-4">
              ...
              <p className="uppercase text-white font-bold text-1xl ">
                &copy; Todos os direitos reservados a Fit Life
              </p>
            </div>
          </div>
